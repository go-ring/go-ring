...
| 프로젝트 이미지 | 상세 내용 |
| :---: | :--- |
| <img src="./assets/images/baekgu.png" width="350" alt="BAEKGU"> | **BAEKGU (백구)**<br>▎*사용자 GitHub 기반 공고 추천 및 자소서 작성 지원 플랫폼*<br><br>기간 : 2026.01.19 ~ 2026.02.06 (3주)<br><br>기술 경험과 재무/뉴스 데이터를 교차 분석하여 공고 매칭 및 증거 중심(Evidence-based) 자소서 작성을 돕는 올인원 솔루션.<br>보안 로직 DB → Redis 전환으로 응답속도 120ms → 5ms 개선 및 CPU 사용률 80% 감소 달성.<br>STOMP 레이어로 인증 시점을 분리하여 채팅 지연시간 10ms 미만으로 단축.<br><br>`Backend` `Infra` \| Java, Spring Boot, Redis, QueryDSL<br><br>[![Repository](https://img.shields.io/badge/Repository-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/go-ring/baekgu) |
| <img src="./assets/images/algogo.png" width="350" alt="Algogo"> | **Algogo (알고고)**<br>▎*알고리즘 스터디 운영 자동화 및 강제적 코드 리뷰 학습 플랫폼*<br><br>기간 : 2025.11.20 ~ 2025.01.20 (9주)<br><br>알고리즘 문제 제출 시스템과 G-Eval AI 코드 분석 엔진을 결합한 스터디 자동화 플랫폼.<br>Blue-Green 배포 안정화를 꾀하여 트래픽 유실 0건 달성.<br>레이어 캐싱 및 Multi-stage 빌드로 CI/CD 배포 파이프라인 66% 단축 (12분 → 4분).<br><br>`Backend` `Infra` \| Spring Boot, MySQL, Docker, GitLab CI/CD<br><br>[![Repository](https://img.shields.io/badge/Repository-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/team-algogo/algogo_server) |
| <img src="./assets/images/ddoya.jpg" width="350" alt="DDOYA"> | **DDOYA (또야)**<br>▎*내 영양제를 종합 분석하고, 복약 일정과 부작용까지 챙겨주는 나만의 스마트 복약 관리 앱*<br><br>기간 : 2026.02.23 ~ 2026.03.29 (5주)<br><br>스마트폰 카메라로 알약과 성분표를 인식하여 맞춤형 분석 리포트와 복약 캘린더를 제공하는 앱.<br>스마트 복약 인증 및 성분 분석 API 파이프라인 구축.<br>FCM 기반 푸시 알림 연동 및 FastAPI와의 데이터 통신 인터페이스 최적화.<br><br>`Backend` `Infra` \| Spring Boot, MySQL, FastAPI, Jenkins<br><br>[![Repository](https://img.shields.io/badge/Repository-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/go-ring/DDOYA) |
| <img src="./assets/images/colorfinder.png" width="350" alt="ColorFinder"> | **ColorFinder**<br>▎*안면 색상 데이터 기반 퍼스널 컬러 진단 및 맞춤형 의류 추천 쇼핑몰*<br><br>기간 : 2024.04.08 ~ 2024.06.10 (10주)<br><br>안면 색상 데이터를 유클리디안 거리 알고리즘으로 분석하여 퍼스널 컬러를 분류하고 기온에 맞는 의류 추천.<br>기상청 실시간 API 응답을 메모리(Local Cache) 처리하여 성능 부하 통제.<br>맞춤형 의류 카테고리 필터링 알고리즘 및 결제 비즈니스 로직 적용.<br><br>`Backend` \| Spring, Flask, MySQL, Python<br><br>[![Repository](https://img.shields.io/badge/Repository-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/chaeha617/capstone_colorfinder) |
